...
const submitComment = async (event) => {
  ...
  const endpoint = "ec2-18-219-206-37.us-east-2.compute.amazonaws.com:5000/comments/PhuketPostComment";
...
const renderComments = async () => {
  const endpoint = "ec2-18-219-206-37.us-east-2.compute.amazonaws.com:5000/getComments/PhuketComments";
  await fetch(endpoint, {
    method: "GET",
    mode: "cors",
  })
...
const getReplies =  (repliesArray,indexOfComment) =>{
  repliesArray.forEach(async (el,index) => {
    ...
    const endpoint = "ec2-18-219-206-37.us-east-2.compute.amazonaws.com:5000/getComments/PhuketReplies"
    await fetch(endpoint,{
    mode: "cors",
    method: "POST",
    headers: {
...
const submitReply = async (event,commentId) =>{
  ...
  const endpoint = "ec2-18-219-206-37.us-east-2.compute.amazonaws.com:5000/comments/PhuketPostReply"
